					...
					<div id = "default">
						<div class="divpage">
							<s:include value="/template/_pager.jsp">
								<s:param name="url">
									showAllSscardBandingInfo?index=card&
								</s:param>	
							</s:include>
						</div>
											...
											<table border="1" class="list_style table_fixed" id="main_list">
												<tbody>
													...
													<tr class="alt1 text_center" onmouseover="highlight(this,'alt1');">
														...
														<td><s:if test="#ulist.sscardCondition==1">使用中</s:if><s:else>未使用</s:else></td>
													</tr>
													<tr class="alt1 text_center" onmouseover="highlight(this,'alt1');">
														<td>  </td>
														<td>  </td>
														...
														<td><a href="getOldSscard?id=<s:property value="#ulist.id"/>" rel="facebox" title="修改社保卡用户" size="s">修改</a>
						                            		<a href="javascript:removeSscard(<s:property value="#ulist.id" />)">删除</a></td>
													</tr>
													<tr class="alt1 text_center" onmouseover="highlight(this,'alt1');">
														<td>&nbsp;</td>
														<td>&nbsp;</td>
