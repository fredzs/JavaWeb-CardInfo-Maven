...
<html>
	...
	<body>
		...
		<script type="text/javascript" charset="gb2312">
			...
			function findById()
			{
				window.location.href="searchCardByCondition?index=card&searchCondition=cardNum&searchValue=" + $('#card_num').val() + "&cardEnv=" + <s:property value="cardEnv"/>;
			}
			
			function findByName()
			{
				window.location.href="searchCardByCondition?index=card&searchCondition=userName&searchValue=" + $('#user_name').val() + "&cardEnv=" + <s:property value="cardEnv"/>;
			}
		</script>
	</body>
</html>