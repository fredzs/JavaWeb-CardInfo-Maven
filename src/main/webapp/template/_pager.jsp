<%@ page contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"
    import="java.util.*,CardInfo.util.*,com.opensymphony.xwork2.*"%>
...
String cardEnv = (String) request.getParameter("cardEnv");
String url = request.getParameter("url") + "cardEnv=" + cardEnv + "&";
int allRecord = new Long(p.getTotal()).intValue();
int pageNow = p.getPageNow().intValue();
int pageSize = p.getPageSize().intValue();
int showPage = p.getShowPage().intValue();
...
//------Page style beings------ 
    ...
    String res = "共" + allRecord + "条记录，" + allPage + "页";
